...
getFilingDetail <- function(form_d_file) {
    ...
    x = data.table(
        ...
        recipientName = checkForZeroStrings(unlist(recipientName)),
        recipientCRDNumber = checkForZeroStrings(unlist(recipientCRDNumber)),
        associatedBDName = checkForZeroStrings(unlist(associatedBDName)),
        associatedBDCRDNumber = checkForZeroStrings(unlist(associatedBDCRDNumber)),
